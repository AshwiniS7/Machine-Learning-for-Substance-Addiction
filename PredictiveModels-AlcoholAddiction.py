...
## for predicting Alcohol addiction 
...
opioid = pre_opioid[['AGE', 'GENDER', 'RACE', 'ETHNIC', 'MARSTAT', 'EDUC', 'EMPLOY', 'VET', 'LIVARAG', 'PRIMINC', 'STFIPS', 'CBSA', 'PMSA', 'REGION', 'DIVISION', 'NOPRIOR', 'PSYPROB','HLTHINS', 'PRIMPAY', 'ALCFLG']].copy()
...
features.remove('ALCFLG')
features



opioid['ALCFLG'].value_counts()
...
dtree_file = 'dtree_model_alcohol.sav'
...
rforest_file = 'randomforest_model_alcohol.sav'
...
logreg_file = 'logreg_model_alcohol.sav'
...
sns.barplot(x = 'AGE', y = 'ALCFLG', data = opioid)



age = opioid[['AGE','ALCFLG']]
age = age[(age['AGE'] != -9)]
...
ax = sns.barplot(x = 'AGE', y = 'ALCFLG', order=['12-14', "15-17", '18-20', '21-24', '25-29', '30-34', '35-39', '40-44', '45-49', '50-54', '>=55'], data =age)

ax.set(xlabel='Age (years)', ylabel='Alcohol Addiction Likelihood')
...
fig = ax.get_figure()
fig.savefig("age_alc.png")



plt.figure(figsize = (20,10))
sns.barplot(x = 'NOPRIOR', y = 'ALCFLG', data = opioid)



nopr = opioid[['NOPRIOR','ALCFLG']]
...
ax = sns.barplot(x = 'NOPRIOR', y = 'ALCFLG', data =nopr)

ax.set(xlabel='# of Prior Treatment Episodes', ylabel= 'Alcohol Addiction Likelihood')
...
fig = ax.get_figure()
fig.savefig("nopr_alc.png")



plt.figure(figsize = (20,10))
sns.barplot(x = 'EDUC', y = 'ALCFLG', data = opioid)



educ = opioid[['EDUC','ALCFLG']]
...
ax = sns.barplot(x = 'EDUC', y = 'ALCFLG', order=['8 or less', "9-11", '12', '13-15', '16 or more'], data = educ)

ax.set(xlabel='Education (highest school grade completed)', ylabel='Alcohol Addiction Likelihood')
...
fig = ax.get_figure()
fig.savefig("educ_alc.png")



plt.figure(figsize = (20,10))
sns.barplot(x = 'MARSTAT', y = 'ALCFLG', data = opioid)



plt.figure(figsize = (20,10))
sns.barplot(x = 'PRIMINC', y = 'ALCFLG', data = opioid)



prim = opioid[['PRIMINC','ALCFLG']]
prim = prim[(prim['PRIMINC'] != -9)]
prim.PRIMINC[prim.PRIMINC == 1] = 'Wages/salary'
prim.PRIMINC[prim.PRIMINC == 2] = 'Public assistance'
prim.PRIMINC[prim.PRIMINC == 3] = 'Retirement/pension'
...
ax = sns.barplot(x = 'PRIMINC', y = 'ALCFLG', order=['Wages/salary', "Public assistance", 'Retirement/pension', 'Other', 'None'], data = prim)

ax.set(xlabel='Source of Income/Support', ylabel='Alcohol Addiction Likelihood')
...
fig = ax.get_figure()
fig.savefig("prim_alc.png")



plt.figure(figsize = (20,10))
sns.barplot(x = 'EMPLOY', y = 'ALCFLG', data = opioid)



empl = opioid[['EMPLOY','ALCFLG']]
...
ax = sns.barplot(x = 'EMPLOY', y = 'ALCFLG', order=['Full time', "Part time", 'Unemployed', 'Not in labor force'], data = empl)

ax.set(xlabel = 'Employment Status', ylabel='Alcohol Addiction Likelihood')
...
fig = ax.get_figure()
fig.savefig("empl_alc.png")



plt.figure(figsize = (20,10))
sns.barplot(x = 'RACE', y = 'ALCFLG', data = opioid)
