...
## for predicting Heroin addiction
...
opioid = pre_opioid[['AGE', 'GENDER', 'RACE', 'ETHNIC', 'MARSTAT', 'EDUC', 'EMPLOY', 'VET', 'LIVARAG', 'PRIMINC', 'STFIPS', 'CBSA', 'PMSA', 'REGION', 'DIVISION', 'NOPRIOR', 'PSYPROB','HLTHINS', 'PRIMPAY', 'HERFLG']].copy()
...
features.remove('HERFLG')
features



opioid['HERFLG'].value_counts()
...
dtree_file = 'dtree_model_heroin.sav'
...
rforest_file = 'randomforest_model_heroin.sav'
...
logreg_file = 'logreg_model_heroin.sav'
...
sns.barplot(x = 'AGE', y = 'HERFLG', data = opioid)



age = opioid[['AGE','HERFLG']]
age = age[(age['AGE'] != -9)]
...
ax = sns.barplot(x = 'AGE', y = 'HERFLG', order=['12-14', "15-17", '18-20', '21-24', '25-29', '30-34', '35-39', '40-44', '45-49', '50-54', '>=55'], data =age)

ax.set(xlabel='Age (years)', ylabel='Heroin Addiction Likelihood')
...
plt.figure(figsize = (20,10))
sns.barplot(x = 'NOPRIOR', y = 'HERFLG', data = opioid)



nopr = opioid[['NOPRIOR','HERFLG']]
...
ax = sns.barplot(x = 'NOPRIOR', y = 'HERFLG', data =nopr)

ax.set(xlabel='# of Prior Treatment Episodes', ylabel= 'Heroin Addiction Likelihood')
...
fig = ax.get_figure()
fig.savefig("nopr_her.png")



plt.figure(figsize = (20,10))
sns.barplot(x = 'EDUC', y = 'HERFLG', data = opioid)



educ = opioid[['EDUC','HERFLG']]
...
ax = sns.barplot(x = 'EDUC', y = 'HERFLG', order=['8 or less', "9-11", '12', '13-15', '16 or more'], data = educ)

ax.set(xlabel='Education (highest school grade completed)', ylabel='Heroin Addiction Likelihood')
...
fig = ax.get_figure()
fig.savefig("educ_her.png")



plt.figure(figsize = (20,10))
sns.barplot(x = 'MARSTAT', y = 'HERFLG', data = opioid)



plt.figure(figsize = (20,10))
sns.barplot(x = 'PRIMINC', y = 'HERFLG', data = opioid)



plt.figure(figsize = (20,10))
sns.barplot(x = 'EMPLOY', y = 'HERFLG', data = opioid)



empl = opioid[['EMPLOY','HERFLG']]
...
ax = sns.barplot(x = 'EMPLOY', y = 'HERFLG', order=['Full time', "Part time", 'Unemployed', 'Not in labor force'], data = empl)

ax.set(xlabel = 'Employment Status', ylabel='Heroin Addiction Likelihood')
...
fig = ax.get_figure()
fig.savefig("empl_her.png")



plt.figure(figsize = (20,10))
sns.barplot(x = 'RACE', y = 'HERFLG', data = opioid)
